...
if opt == '1':
    ...
    offset = input('\033[1;34m[=]\033[0m ROT Offset: ')
    out = rotencode(importx, infile, outfile, format1, text, exportx, offset)
    ...
    offset = input('\033[1;34m[=]\033[0m ROT Offset: ')
    out = rotdecode(importx, infile, outfile, format1, text, exportx, int(offset))
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
else:
    print('\033[1;31m[-]\033[0m Unknown option')
