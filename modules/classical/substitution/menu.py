...
if opt == '1':
    ...
    out = simsubencode(importx, infile, outfile, format1,  exportx, text, key)
    ...
    key = input('\033[1;34m[=]\033[0m Key: ')
    out = simsubdecode(importx, infile, outfile, format1,  exportx, text, key)
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
elif opt == '3':
    opt2 = input('\033[1;34m[=]\033[0m [F]ile or [T]ext: ')
