...
if opt == '1':
    ...
    rails = input('\033[1;34m[=]\033[0m Rails: ')
    offset = input('\033[1;34m[=]\033[0m Offset: ')
    out = railfenceencode(importx, infile, outfile, format1,  exportx, text, offset, rails)
    ...
    rails = input('\033[1;34m[=]\033[0m Rails: ')
    offset = input('\033[1;34m[=]\033[0m Offset: ')
    out = railfencedecode(importx, infile, outfile, format1, exportx, text, offset, rails)
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
else:
    print('\033[1;31m[-]\033[0m Unknown option')
