...
if opt == '1':
    ...
    n = input('\033[1;34m[=]\033[0m Number: ')
    out = bifidencode(importx, infile, outfile, format1, exportx, text, key, n)
    ...
    key = input('\033[1;34m[=]\033[0m Key: ')
    n = input('\033[1;34m[=]\033[0m Number: ')
    out = bifiddecode(importx, infile, outfile, format1, exportx, text, key, n)
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
else:
    print('\033[1;31m[-]\033[0m Unknown option')
