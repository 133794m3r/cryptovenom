...
if opt == '1':
    ...
    out = coltransencode(importx, infile, outfile, format1,  exportx, text, key)
    ...
    out = coltransdecode(importx, infile, outfile, format1,  exportx, text, key)
    ...
    coln = input('\033[1;34m[=]\033[0m Number of Columns: ')
