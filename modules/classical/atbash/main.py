...
def atbashencode(importx, infilepath, outfilepath, inputformat, exportx, raw):
    if importx == 'file':
        f = open(infilepath, 'r')
        raw = f.read()
        f.close()
...
def atbashdecode(importx, infilepath, outfilepath, outputformat, exportx, raw):
    if importx == 'file':
        f = open(infilepath, 'r')
        raw = f.read()
        f.close()
