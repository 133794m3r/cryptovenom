...
if opt == '1':
    ...
    out = rc4cipher(importx, exportx, infile, outfile, 'raw', passwd, raw, keyimport, format1)
    ...
    passwd = input('\033[1;34m[=]\033[0m Key: ')
    out = rc4cipher(importx, exportx, infile, outfile, format1, passwd, raw, keyimport, 'raw')
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
elif opt == '3':
    print('NOT YET')
