...
-=[OPTIONS]=-
   ...
   ''')
    ...
    out = encryptRc2(type1, importx, infile, exportx, outfile, format1, ivtype, iv, passwd, raw, keyimport)
...
-=[OPTIONS]=-
   ...
   ''')    
    ...
    if ivtype == '1':
        ...
        print('\033[1;31m[-]\033[0m Unknown option')
    passwd = input('\033[1;34m[=]\033[0m Key: ')
    out = decryptRc2(type1, importx, infile, exportx, outfile, format1, ivtype, iv, passwd, raw)
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
elif opt == '3':
    print('NOT YET')
