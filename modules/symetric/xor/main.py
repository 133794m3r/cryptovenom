...
def encryptxor(importx, impfilepath, exportx, expfilepath, inputformat, passwd, raw, keyimport, outputformat):
    if keyimport == 'base64':
    ...
    if exportx == 'file':
        ...
        print('\033[1;31m[-]\033[0m Unknown error.')
        return False
def decryptxor(importx, impfilepath,exportx, expfilepath, inputformat, passwd, raw, keyimport, outputformat):
    if keyimport == 'base64':
        key = base64.b64decode(passwd)
    elif keyimport == 'raw':
        key = passwd 
