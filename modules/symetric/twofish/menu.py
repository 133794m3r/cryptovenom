...
if opt == '1':
    ...
    out = encrypttwofish(importx, infile, exportx, outfile, format1, passwd, raw, keyimport)
    ...
    passwd = input('\033[1;34m[=]\033[0m Key: ')
    out = decrypttwofish(importx, infile, exportx, outputenc, outfile, format1, passwd, raw, keyimport)
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
elif opt == '3':
    print('NOT YET')
