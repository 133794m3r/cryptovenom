...
-=[OPTIONS]=-
   ...
   ''')
    ...
    out = encryptDes3(type1, importx, infile, exportx, outfile, format1, ivtype, iv, passwd, raw, keyimport)
...
-=[OPTIONS]=-
   ...
   ''')
    ...
    keyimport = input('\033[1;34m[=]\033[0m Key Encoding Import (eg.: raw or base64): ')
    passwd = input('\033[1;34m[=]\033[0m Key: ')
    print("Enter output format: eg raw or base64")
    outputenc = input()
    out = decryptDes3(type1, importx, infile, exportx, outputenc, outfile, format1, ivtype, iv, passwd, raw, keyimport)
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
elif opt == '3':
    print('NOT YET')
