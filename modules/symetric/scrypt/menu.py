...
if opt == '1':
    ...
    out = encryptscrypt(importx, infile, exportx, outfile, raw, keyimport, passwd, format1, 'raw')
    ...
    keyimport = input('\033[1;34m[=]\033[0m Key Encoding Import (eg.: raw or base64): ')
    passwd = input('\033[1;34m[=]\033[0m Key: ')
    out = decryptscrypt(importx, infile, exportx, outfile, raw, keyimport, passwd, format1, 'raw')
    print('\033[1;32m[+]\033[0m Out = ' + str(out))
    print('\033[1;32m[+]\033[0m All done!')
elif opt == '3':
    print('NOT YET')
